...
void glTexEnvf(GLint, GLint, GLint) {};
void glOrtho(GLfloat,GLfloat,GLfloat,GLfloat,GLfloat,GLfloat){};
void glVertex2i(GLint,GLint) {};
void glFogi(GLint, GLint) {};
void glFogfv(GLint, const GLfloat*) {};
void glFogf(GLint, GLfloat) {};
void glTexParameterf(GLint, GLint, GLint) {};
void glDepthFunc(GLfloat) {};

void glTexGenfv(GLfloat) {};
void glTexGeni(GLfloat) {};
void glPixelStorei(GLfloat) {};
